...
class Select extends Component {
  ...
  getLocals() {
    ...
    // Default to true if not specified for backward compatability
    locals.collapseOnChange =
      "collapseOnChange" in this.props.options
        ? this.props.options.collapseOnChange
        : true;
